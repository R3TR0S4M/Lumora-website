...
type Page = '/' | '/students' | '/study-in-malaysia' | '/course-finder' | '/how-to-apply' | '/resources' | '/application-progress' | '/about' | '/contact' | '/privacy';
...
export default function App() {
  const pageFromPath = (): Page => (['/', '/students', '/study-in-malaysia', '/course-finder', '/how-to-apply', '/resources', '/application-progress', '/about', '/contact', '/privacy'].includes(window.location.pathname) ? window.location.pathname as Page : '/');
